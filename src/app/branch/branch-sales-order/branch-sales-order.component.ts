...
@Component({
  selector: 'app-branch-sales-order',
  templateUrl: './branch-sales-order.component.html',
})
export class BranchSalesOrderComponent implements OnInit {
  ...
  loading: any;
    ...
    salesOrderList(status:any = '') {
      ...
      this.db.post_rqst(  {'filter':this.filter,'branch_id':this.franchise_id }, 'sales/orderList?page=' + this.current_page )
