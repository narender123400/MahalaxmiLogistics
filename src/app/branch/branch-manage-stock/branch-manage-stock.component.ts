...
@Component({
  selector: 'app-branch-manage-stock',
  templateUrl: './branch-manage-stock.component.html'
})
export class BranchManageStockComponent implements OnInit {
  ...
  getProductList() {
    ...
    const typ = 'Product';
    this.db.post_rqst( {'branch_id': this.franchise_id } , 'branches/list_add_manage_stock?page=' + this.current_page + '&s=' + this.search + '&t=' + typ)
