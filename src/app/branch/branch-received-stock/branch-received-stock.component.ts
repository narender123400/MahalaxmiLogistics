...
@Component({
  selector: 'app-branch-received-stock',
  templateUrl: './branch-received-stock.component.html'
})
export class BranchReceivedStockComponent implements OnInit {
  ...
  getProductList() {
    ...
    this.db.post_rqst(  {'branch_id': this.franchise_id , 'filter' : this.filter }, 'sales/transfer_stock_list?page=' + this.current_page + '&s=' + this.search + '&t=' + typ)
      .subscribe(data => {
        console.log(data);
