...
@Component({
  selector: 'app-branch-scrap',
  templateUrl: './branch-scrap.component.html',
})
export class BranchScrapComponent implements OnInit {
  ...
  getProductList() {
    ...
    const typ = 'Product';
    this.db.post_rqst( {'branch_id': this.franchise_id } , 'branches/branch_scrap?page=' + this.current_page + '&s=' + this.search + '&t=' + typ)
