...
@Component({
  selector: 'app-branch-inter-branch-add',
  templateUrl: './branch-inter-branch-add.component.html',
  
})
export class BranchInterBranchAddComponent implements OnInit {
  ...
  constructor(public db: DatabaseService,
    ...
    ngOnInit() {
      ...
      this.route.params.subscribe(params => {
          console.log(params);
          this.branch_from_id = params['franchise_id'];
          console.log(this.invoiceData.order_id);
     

        // this.change_invoice_id();

        console.log(this.branch_from_id)
...
console.log( this.data );
                      ...
                      if( this.invoiceItemList.findIndex(x => x.id == this.data.part_id  ) > -1 ){
...
console.log(this.invoiceItemList);
    ...
    submit_sales_invoice()
    {
        ...
        this.db.post_rqst( { 'stock':this.invoiceData, 'data':this.data ,'total_amount': this.invoice_data.total_amount } , 'branches/branchInterStockTxransfer')
        .subscribe((result: any) => {
