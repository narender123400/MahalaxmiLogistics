...
@Component({
  selector: 'app-branch-consignee-list',
  templateUrl: './branch-consignee-list.component.html',
})
export class BranchConsigneeListComponent implements OnInit {
...
redirect_next() {
  ...
  getConsumers() {
    ...
    this.db.post_rqst(  {'filter':this.filter , 'l_id':this.franchise_id}, 'branches/branch_consignee?page='+this.current_page)
    .subscribe(d => {
      console.log(d);
