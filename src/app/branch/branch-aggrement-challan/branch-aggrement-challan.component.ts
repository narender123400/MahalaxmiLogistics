...
@Component({
  selector: 'app-branch-aggrement-challan',
  templateUrl: './branch-aggrement-challan.component.html',
})
export class BranchAggrementChallanComponent implements OnInit {
  ...
  loading: any;
    ...
    salesOrderList(status:any = '') {
      ...
      this.db.post_rqst(  {'filter':this.filter,'branch_id':this.franchise_id }, 'sales/AggrementchallanList?page=' + this.current_page )
      //this.db.post_rqst( '', 'sales/orderList')
        .subscribe(data => {     
          ...
          this.loading_list = false;
            ...
            this.totalorder = this.data.data.salesOrderList.total;
  ...
  // navigate(){
  //   this.router.navigate(['/sale-challan-invoice']);
