...
@Component({
  selector: 'app-branch-challan',
  templateUrl: './branch-challan.component.html',
})
export class BranchChallanComponent implements OnInit {
  ...
  loading: any;
    ...
    salesOrderList(status:any = '') {
      ...
      this.db.post_rqst(  {'filter':this.filter,'branch_id':this.franchise_id }, 'sales/challanList?page=' + this.current_page )
