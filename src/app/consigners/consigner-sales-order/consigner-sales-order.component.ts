...
@Component({
  selector: 'app-consigner-sales-order',
  templateUrl: './consigner-sales-order.component.html'
})
export class ConsignerSalesOrderComponent implements OnInit {
  ...
  salesOrderList(status:any = '') {
    ...
    this.db.post_rqst(  {'filter':this.filter,'consigner_id':this.franchise_id }, 'sales/orderList?page=' + this.current_page )
