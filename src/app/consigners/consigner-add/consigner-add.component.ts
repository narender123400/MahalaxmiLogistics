...
@Component({
  selector: 'app-consigner-add',
  templateUrl: './consigner-add.component.html',
})
export class ConsignerAddComponent implements OnInit {
  ...
  constructor(public db: DatabaseService, private route: ActivatedRoute, private router: Router, public ses: SessionStorage,
    ...
    getBranches() {
      this.db.post_rqst( '', 'branches/getBranch_name')
      .subscribe( d  => {
    ...
    saveFranchiseLead(form:any) {
      ...
      this.db.insert_rqst( {'tmp':tmp}, 'consigners/consigners_add')
      .subscribe(data => {
        ...
        if(data['data'].msg == 'Success' )
        {
          ...
          this.router.navigate(['consigner-detail/'+ data['data'].id ] );
