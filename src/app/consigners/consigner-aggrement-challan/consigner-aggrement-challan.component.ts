...
@Component({
  selector: 'app-consigner-aggrement-challan',
  templateUrl: './consigner-aggrement-challan.component.html',
})
export class ConsignerAggrementChallanComponent implements OnInit {
  ...
  loading: any;
    ...
    salesOrderList(status:any = '') {
      ...
      this.db.post_rqst(  {'filter':this.filter,'consigner_id':this.franchise_id }, 'sales/AggrementchallanList?page=' + this.current_page )
