...
@Component({
  selector: 'app-consigner-challan',
  templateUrl: './consigner-challan.component.html'
})
export class ConsignerChallanComponent implements OnInit {
  ...
  salesOrderList(status:any = '') {
    ...
    this.db.post_rqst(  {'filter':this.filter,'consigner_id':this.franchise_id }, 'sales/challanList?page=' + this.current_page )
