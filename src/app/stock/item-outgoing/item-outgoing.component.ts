...
@Component({
  selector: 'app-item-outgoing',
  templateUrl: './item-outgoing.component.html',
})
export class ItemOutgoingComponent implements OnInit {
  ...
  getProductDetail() {
    ...
    this.db.post_rqst(  { 'id':this.prod_id,  'unit_id':this.unit_id , 'category':'Accessory' }, 'sales/accessory_outgoing')
      .subscribe(data => {
