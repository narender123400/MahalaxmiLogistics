...
@Component({
  selector: 'app-material-incoming',
  templateUrl: './material-incoming.component.html'
})
export class MaterialIncomingComponent implements OnInit {
  ...
  getProductDetail() {
    ...
    this.db.post_rqst(  { 'id':this.prod_id,  'unit_id':this.unit_id }, 'stock/getIncomeProduct')
      .subscribe(data => {
        ...
        this.vendor_item_data = this.data.data.vendor_item_data;
