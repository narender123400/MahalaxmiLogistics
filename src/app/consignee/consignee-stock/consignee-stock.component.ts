...
// import { ConsigneeStockModelComponent } from '../consignee-stock-model/consignee-stock-model.component';

@Component({
  selector: 'app-consignee-stock',
  templateUrl: './consignee-stock.component.html'
})
export class ConsigneeStockComponent implements OnInit {
  ...
  //   const dialogRef = this.dialogs.open(ConsigneeStockModelComponent, {
  //     width: '850px',
  //     data: {
  //       'id' : id,
  //       'mode' : mode,
  ...
  getProductList() {
    ...
    const typ = 'Product';
    this.db.post_rqst( {'consignee_id': this.franchise_id } , 'consignee/get_consignee_stock?page=' + this.current_page + '&s=' + this.search + '&t=' + typ)
