...
@Component({
  selector: 'app-consignee-challan',
  templateUrl: './consignee-challan.component.html'
})
export class ConsigneeChallanComponent implements OnInit {
  ...
  salesOrderList(status:any = '') {
    ...
    this.db.post_rqst(  {'filter':this.filter,'consignee_id':this.franchise_id }, 'sales/challanList?page=' + this.current_page )
